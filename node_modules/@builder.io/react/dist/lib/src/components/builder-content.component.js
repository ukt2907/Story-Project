...
var BuilderContent = /** @class */ (function (_super) {
    ...
    BuilderContent.prototype.subscribeToContent = function () {
        ...
        if (this.name !== '_inline') {
            ...
            this.subscriptions.add(this.builder.queueGetContent(this.name, this.options).subscribe(function (matches) {
                ...
                var isPreviewing = (_this.builder.editingModel || _this.builder.previewingModel) === _this.name;
